const errorHandler = (err, req, res, next) =>
{
  ...
  else if ((err?.message.includes(`No tenemos stock suficiente de ${productInDb.title}, actualmente tenemos ${productInDb.stock}u`)) || (err?.message.includes(`El producto ${productInDb.title} se encuentra sin stock.`))){
    console.log(err.stack);
