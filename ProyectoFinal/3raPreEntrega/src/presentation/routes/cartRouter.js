...
cartRouter.post('/', CartController.saveCart); // Crea un carrito
cartRouter.get('/:userId', CartController.getOneCart); // Obtiene un carrito a partir del id del usuario
...
cartRouter.post('/:cid/purchase', CartController.checkout) // Finalizar compra
